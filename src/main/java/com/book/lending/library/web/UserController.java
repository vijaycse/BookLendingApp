...
public class UserController {  
    ...
    public @ResponseBody List<UserDetails> getPersonList() {  
        return personService.listPerson();
    }  
     
    @RequestMapping(value = "/user", method = RequestMethod.POST)  
    public ResponseEntity<String> createPerson(@RequestBody UserDetails person) {
    ...
    public ResponseEntity<String> deletePerson(@RequestBody UserDetails person) {  
